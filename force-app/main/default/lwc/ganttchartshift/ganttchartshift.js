...
// Static resources
import GantChartfile from "@salesforce/resourceUrl/GantChartfile";
...
export default class Ganttchartshift extends LightningElement {
    let today = new Date();
    today.setUTCHours(0);
...
// Set to 00:00:00:000 today
    ...
    renderedCallback() {
        ...
        Promise.all([
            loadScript(this, GantChartfile + '/accessibility.js'),
            loadScript(this, GantChartfile + '/exporting.js'),
            loadScript(this, GantChartfile + '/highcharts-gantt.js'),
            //loadStyle(this, GantChartfile + '/fullcalendar.min.css'),
